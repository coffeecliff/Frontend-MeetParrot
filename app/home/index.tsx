    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                <View style={styles.card}>
                    ...
                    <Text style={styles.cardDescription}>
                        Converse com pessoas ao redor do mundo e encontre pessoas que gostam dos mesmos interesses que os seus!
                    </Text>
                </View>
            ...
            <View style={styles.buttons}>
                <Button title='Começar a Conversar' onPress={handleStartChat} style={styles.button} />
                <Button title='Conheça mais sobre o app' onPress={handleAbout} style={styles.button} variant='outline' />
